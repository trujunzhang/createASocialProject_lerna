...
import * as Icons from '../svgs/materialDesignIcons'
// import { FaAdn } from '../svgs/materialDesignIcons '
const vectorIconDisplayName = 'MaterialIcons'
...
export class MaterialIcons extends React.Component<IconProps, any> {
  ...
  render() {
    ...
    const svgClassName = 'Md' + UpperCaseStringUtils.toCamelClassName(name)
