...
import {
  materialThemeDefaultVariables,
  inverseTextColor,
  iconFontSize,
  fontSizeBase
} from '../materialVariables'
import { material } from '../../utils'

// Color
export const brandPrimary = material === 'ios' ? '#007aff' : '#3F51B5'
...
export const buttonVariables: IButtonVariables = {
  // Button
  btnFontFamily: materialThemeDefaultVariables.btnFontFamily,
...
export const buttonFuncVariables: IButtonFuncVariables = {
  ...
  btnTextSize: () => {
    return material === 'ios' ? fontSizeBase * 1.1 : fontSizeBase - 1
  },
  btnTextSizeLarge: () => {
