...
class Icon extends React.Component {
    ...
    render() {
        if (this.props.ios && this.props.android) {
            return (React.createElement(IconNB, Object.assign({ ref: (c) => (this._root = c) }, this.props, { name: Platform.OS === 'ios' ? this.props.ios : this.props.android })));
        }
        else if (this.props.name && (this.props.android || this.props.ios)) {
            return React.createElement(IconNB, Object.assign({ ref: (c) => (this._root = c) }, this.props, { name: this.getIconName() }));
        }
        else {
            return React.createElement(IconNB, Object.assign({ ref: (c) => (this._root = c) }, this.props, { name: this.getName() }));
        }
    }
}
Icon.contextTypes = {
