...
class DeckSwiper extends React.Component {
    ...
    render() {
        if (this.state.disabled) {
            ...
            return (React.createElement(View, { style: { position: 'relative', flexDirection: 'column' } }, React.createElement(View, null, this.props.renderEmpty && this.props.renderEmpty())));
        }
        else if (this.state.lastCard) {
            // display renderEmpty underneath last viable card
            return (React.createElement(View, { style: { position: 'relative', flexDirection: 'column' } }, this.state.selectedItem === undefined ? (React.createElement(View, null)) : (React.createElement(View, null,
                React.createElement(Animated.View, Object.assign({ style: [
                        this.getCardStyles()[1],
                        this.getInitialStyle().topCard,
                        { opacity: this.state.fadeAnim }
                    ] }, this._panResponder.panHandlers), this.props.renderEmpty && this.props.renderEmpty()),
                React.createElement(Animated.View, Object.assign({ style: [this.getCardStyles()[0], this.getInitialStyle().topCard] }, this._panResponder.panHandlers), this.props.renderItem(this.state.selectedItem))))));
        }
        return (React.createElement(View, { style: { position: 'relative', flexDirection: 'column' } }, this.state.selectedItem === undefined ? (React.createElement(View, null)) : (React.createElement(View, null,
            React.createElement(Animated.View, Object.assign({ style: [
                    this.getCardStyles()[1],
                    this.getInitialStyle().topCard,
                    { opacity: this.state.fadeAnim }
                ] }, this._panResponder.panHandlers), this.props.renderBottom
                ? this.props.renderBottom(this.state.selectedItem2)
                : this.props.renderItem(this.state.selectedItem2)),
            React.createElement(Animated.View, Object.assign({ style: [this.getCardStyles()[0], this.getInitialStyle().topCard] }, this._panResponder.panHandlers), this.props.renderTop
