...
import { Platform, Animated, Dimensions, TouchableOpacity, TouchableNativeFeedback, View, StyleSheet } from 'react-primitives';
...
class Fab extends React.Component {
    ...
    fabOtherBtns(direction, i) {
        if (direction === 'up') {
            return {
                top: undefined,
                bottom: this.props.active === false ? (Platform.OS === 'ios' ? 50 : 5) : i * 50 + 65,
                left: 8,
                right: 0
            };
        }
            ...
            return {
                top: 8,
                bottom: 0,
                left: this.props.active === false ? (Platform.OS === 'ios' ? 8 : 8) : -(i * 50 + 58),
                right: 0
            };
        }
        else if (direction === 'down') {
            return {
                top: this.props.active === false ? (Platform.OS === 'ios' ? 50 : 8) : i * 50 + 73,
                bottom: 0,
                left: 8,
                right: 0
            };
            ...
            return {
                top: 8,
                bottom: 0,
                left: this.props.active === false ? (Platform.OS === 'ios' ? 50 : 8) : i * 50 + 73,
                right: 0
            };
        }
    }
    ...
    renderButtons() {
        ...
        let newChildren = [];
        {
            childrenArray.slice(1).map((child, i) => {
                newChildren.push(React.createElement(AnimatedFab, Object.assign({ style: this.getOtherButtonStyle(child, i) }, this.prepareButtonProps(child, i), { fabButton: true, key: i }), child.props.children));
            });
        }
        return newChildren;
    }
    ...
    render() {
        ...
        return (React.createElement(Animated.View, { style: this.getContainerStyle() },
            this.renderButtons(),
            Platform.OS === 'ios' || variables.androidRipple === false || Platform['Version'] <= 21 ? (React.createElement(TouchableOpacity, Object.assign({ onPress: () => this.fabOnPress() }, this.prepareFabProps(), { activeOpacity: 1 }), this.renderFab())) : (React.createElement(TouchableNativeFeedback, Object.assign({ onPress: () => this.fabOnPress(), background: TouchableNativeFeedback.Ripple(variables.androidRippleColor, false) }, this.prepareFabProps()),
                React.createElement(View, { style: [this.getInitialStyle().fab, this.props.style] }, this.renderFab())))));
    }
}
