import { PixelRatio, StatusBar } from 'react-primitives'
import { IThemeVariables } from '@app/tools' // typings

import * as Props from './props'
// import * as Base from './base'

export const headerTheme = (variables: IThemeVariables) => {
  const platformStyle = variables.platformStyle
  const platform = variables.platform

  const headerTheme = {
    '.span': Props.spanProps(variables, platform, platformStyle),
    '.hasSubtitle': Props.hasSubtitleProps(variables, platform, platformStyle),
    '.transparent': Props.transparentProps(variables, platform, platformStyle),
    '.noShadow': Props.noShadowProps(variables, platform, platformStyle),
