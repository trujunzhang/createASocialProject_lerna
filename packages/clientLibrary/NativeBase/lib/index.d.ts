// declare module '@app/native-base' {
...
namespace NativeBase {
  ...
  interface Button extends ReactNative.TouchableOpacityProperties, BsStyle {
    ...
    iconLeft?: boolean
    /**
     * Used for SVG alignment.
     * Aligns svg to the left in button.
     * By default, svg are aligned to the left in button.
     */
    svgLeft?: boolean
    onlyCenter?: boolean
    twitter?: boolean
  ...
  export interface ListSwipeRow extends SwipeRow {
    list?: boolean
    closeOnRowBeginSwipe?: boolean
    listSwipeHelper: any
...
// iconTypeConstants.
// =================
export const IconVectorTypeEntypo: string
export const IconVectorTypeEvilIcons: string
export const IconVectorTypeFeather: string
export const IconVectorTypeFontAwesome: string
export const IconVectorTypeFoundation: string
export const IconVectorTypeIonicons: string
export const IconVectorTypeMaterialCommunityIcons: string
export const IconVectorTypeMaterialIcons: string
export const IconVectorTypeOcticons: string
export const IconVectorTypeSimpleLineIcons: string
export const IconVectorTypeZocial: string

// checkIsIphoneX.
// =================
export declare function checkIsIphoneX(): boolean
